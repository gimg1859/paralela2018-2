...
public class ReciprocalArraySumTest extends TestCase {
    // Número de veces que se debe repetir cada prueba, para la consistencia de los resultados de en el tiempo.
    ...
    /**
     * Una función 'helper' para hacer las pruebas de la implementación de dos y de muchas tareas en paralelo.
     *
    ...
    /**
     * Prueba que la implementación de dos tareas en paralelo calcula correctamente los resultados para arreglos un millón de elementos.
     */
